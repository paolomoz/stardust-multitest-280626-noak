...
// ---------- FOOTER FRAGMENT ----------
{
  const cols = {
    ...
    'Social Impact': [['Communities', 'https://about.starbucks.com/communities/'], ['Starbucks Foundation', 'https://about.starbucks.com/the-starbucks-foundation/'], ['Sustainability', 'https://about.starbucks.com/sustainability/'], ['Reporting Hub', '/starbucks/responsibility/reporting-hub']],
    'For Business Partners': [['Landlord Support Center', '/starbucks/business/landlord-faq'], ['Suppliers', '/starbucks/business/suppliers'], ['Corporate Gift Card Sales', 'https://www.starbuckscardb2b.com/']],
    'Order and Pick Up': [['Order on the App', 'https://www.starbucks.com/rewards/mobile-apps/'], ['Order on the Web', '/starbucks/menu'], ['Delivery', '/starbucks/stores-and-ordering/delivery'], ['Order and Pick Up Options', '/starbucks/stores-and-ordering']],
  };
